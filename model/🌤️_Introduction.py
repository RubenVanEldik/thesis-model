...
st.markdown(
    ...
    This is an optimization model for a fully intermittent renewable Pan-European electricity grid. This model allows you to change the scopen in the geographical, temporal and technological domain.
