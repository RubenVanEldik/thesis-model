...
def firm_lcoe(output_directory, resolution, *, countries=None):
    ...
    storage_capacity = utils.get_storage_capacity(output_directory, resolution, countries=countries)
    temporal_results = utils.get_temporal_results(output_directory, resolution, countries=countries)
...
def relative_curtailment(output_directory, resolution, *, countries=None):
    """
    ...
    temporal_results = utils.get_temporal_results(output_directory, resolution, group="all", countries=countries)
    return temporal_results.curtailed_MW.sum() / temporal_results.production_total_MW.sum()


def production_capacity(output_directory, resolution, *, countries=None):
    """
    ...
    production_capacity = utils.get_production_capacity(output_directory, resolution, group="all", countries=countries)
    return production_capacity.to_dict()


def storage_capacity(output_directory, resolution, *, type, countries=None):
    """
    ...
    storage_capacity = utils.get_storage_capacity(output_directory, resolution, group="all", countries=countries)
...
def self_sufficiency(output_directory, resolution, *, countries=None):
    """
